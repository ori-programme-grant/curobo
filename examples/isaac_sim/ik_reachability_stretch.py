...
def get_pose_grid(n_x, n_y, n_z, min_x, min_y, max_x, max_y, max_z):
...
def main():
    ...
    world_cfg_table.cuboid[0].pose[2] -= 0.5
    ...
    position_grid_offset = tensor_args.to_device(get_pose_grid(10, 10, 5, min_x=-1.0, min_y=-0.5, max_x=1.0, max_y=1.5, max_z=0.5))
